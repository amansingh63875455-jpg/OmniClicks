...
const HISTORY_DB: Record<string, { title: string; year: string; description: string; link: string; source: string }[]> = {
    '01-03': [
        { title: 'Bitcoin Genesis Block Mined', year: '2009', description: 'Satoshi Nakamoto mined the first Bitcoin block, embedding the message "The Times 03/Jan/2009 Chancellor on brink of second bailout for banks"', link: 'https://en.wikipedia.org/wiki/History_of_bitcoin#Creation', source: 'Wikipedia' },
        { title: 'Apple Computer Incorporated', year: '1977', description: 'Apple Computer Company was officially incorporated, marking the beginning of personal computing revolution', link: 'https://en.wikipedia.org/wiki/History_of_Apple_Inc.', source: 'Wikipedia' },
    ],
    '02-14': [
        { title: 'YouTube Founded', year: '2005', description: 'YouTube was founded by three former PayPal employees, revolutionizing online video sharing and creating new opportunities for content monetization and digital advertising.', link: 'https://en.wikipedia.org/wiki/History_of_YouTube', source: 'Wikipedia' },
        { title: 'Nasdaq Stock Market Founded', year: '1971', description: 'The Nasdaq Stock Market began operations as the world\'s first electronic stock market, transforming how securities are traded globally.', link: 'https://en.wikipedia.org/wiki/Nasdaq', source: 'Wikipedia' },
    ],
    '03-10': [
        { title: 'Silicon Valley Bank Collapse', year: '2023', description: 'Silicon Valley Bank failed in the second-largest bank failure in U.S. history, triggering concerns about the stability of regional banks and the tech startup ecosystem.', link: 'https://en.wikipedia.org/wiki/Collapse_of_Silicon_Valley_Bank', source: 'Wikipedia' },
        { title: 'NASDAQ Composite Peaks', year: '2000', description: 'The NASDAQ Composite index reached its dot-com bubble peak of 5,048.62 before the subsequent crash that reshaped the tech industry.', link: 'https://en.wikipedia.org/wiki/Dot-com_bubble', source: 'Wikipedia' },
    ],
    '04-04': [
        { title: 'Microsoft Founded', year: '1975', description: 'Bill Gates and Paul Allen founded Microsoft, which would become the world\'s largest software company and transform personal computing forever.', link: 'https://en.wikipedia.org/wiki/History_of_Microsoft', source: 'Wikipedia' },
        { title: 'Netscape IPO', year: '1995', description: 'Netscape Communications went public in one of the most successful IPOs ever, marking the beginning of the dot-com boom.', link: 'https://en.wikipedia.org/wiki/Netscape#Initial_public_offering', source: 'Wikipedia' },
    ],
    '05-18': [
        { title: 'Visa Inc. IPO', year: '2008', description: 'Visa Inc. completed the largest IPO in U.S. history at the time, raising $17.9 billion and transforming the global payments landscape.', link: 'https://en.wikipedia.org/wiki/Visa_Inc.#Initial_public_offering', source: 'Wikipedia' },
        { title: 'eBay Founded', year: '1995', description: 'Pierre Omidyar founded eBay (originally AuctionWeb), creating one of the first major e-commerce platforms and pioneering online marketplace business models.', link: 'https://en.wikipedia.org/wiki/EBay#History', source: 'Wikipedia' },
    ],
    '06-29': [
        { title: 'iPhone Released', year: '2007', description: 'Apple released the first iPhone, revolutionizing mobile computing and enabling the mobile payments revolution that followed.', link: 'https://en.wikipedia.org/wiki/IPhone_(1st_generation)', source: 'Wikipedia' },
        { title: 'Google IPO', year: '2004', description: 'Google went public with an unconventional Dutch auction IPO, raising $1.67 billion and beginning its transformation into one of the world\'s most valuable companies.', link: 'https://en.wikipedia.org/wiki/Initial_public_offering_of_Google', source: 'Wikipedia' },
    ],
    '07-15': [
        { title: 'Amazon Prime Day Launched', year: '2015', description: 'Amazon introduced Prime Day, creating a new global shopping event that would generate billions in revenue and transform e-commerce.', link: 'https://en.wikipedia.org/wiki/Amazon_Prime#Prime_Day', source: 'Wikipedia' },
        { title: 'Twitter Founded', year: '2006', description: 'Jack Dorsey, Noah Glass, Biz Stone, and Evan Williams launched Twitter, creating a new platform for real-time communication and information sharing.', link: 'https://en.wikipedia.org/wiki/Twitter#History', source: 'Wikipedia' },
    ],
    '08-09': [
        { title: 'Uber Founded', year: '2009', description: 'Travis Kalanick and Garrett Camp founded Uber, disrupting the transportation industry and pioneering the gig economy model.', link: 'https://en.wikipedia.org/wiki/Uber#History', source: 'Wikipedia' },
        { title: 'Alibaba Founded', year: '1999', description: 'Jack Ma founded Alibaba Group in China, which would become one of the world\'s largest e-commerce and technology conglomerates.', link: 'https://en.wikipedia.org/wiki/Alibaba_Group#History', source: 'Wikipedia' },
    ],
    '09-15': [
        { title: 'Lehman Brothers Files for Bankruptcy', year: '2008', description: 'The collapse of Lehman Brothers triggered the global financial crisis, leading to major regulatory reforms', link: 'https://en.wikipedia.org/wiki/Bankruptcy_of_Lehman_Brothers', source: 'Wikipedia' },
        { title: 'First ATM Installed in US', year: '1969', description: 'Chemical Bank installed the first ATM in the United States in Rockville Centre, New York', link: 'https://en.wikipedia.org/wiki/Automated_teller_machine#History', source: 'Wikipedia' },
    ],
    '10-31': [
        { title: 'Bitcoin Whitepaper Published', year: '2008', description: 'Satoshi Nakamoto published the Bitcoin whitepaper titled "Bitcoin: A Peer-to-Peer Electronic Cash System"', link: 'https://en.wikipedia.org/wiki/Bitcoin#Creation', source: 'Wikipedia' },
        { title: 'New York Stock Exchange Crash', year: '1929', description: 'Black Tuesday marked the most devastating stock market crash in US history', link: 'https://en.wikipedia.org/wiki/Wall_Street_Crash_of_1929', source: 'Wikipedia' },
    ],
    '11-24': [
        { title: 'PayPal Goes Public', year: '2002', description: 'PayPal Holdings Inc. completed its IPO on NASDAQ, revolutionizing online payments. The company transformed how people send and receive money online, making digital payments accessible to millions worldwide.', link: 'https://en.wikipedia.org/wiki/PayPal#History', source: 'Wikipedia' },
        { title: 'First Bitcoin ATM Installed', year: '2013', description: "The world's first Bitcoin ATM was installed in Vancouver, Canada, marking a significant milestone in cryptocurrency adoption. This machine allowed users to exchange cash for Bitcoin instantly, bridging the gap between traditional and digital currency.", link: 'https://en.wikipedia.org/wiki/Bitcoin_ATM', source: 'Wikipedia' },
        ...
        { title: 'Square Inc. Founded', year: '2009', description: "Jack Dorsey and Jim McKelvey founded Square to enable mobile payments for small businesses. The company's card reader transformed smartphones into payment terminals, democratizing access to credit‑card processing.", link: 'https://en.wikipedia.org/wiki/Block,_Inc.#History', source: 'Wikipedia' },
        { title: 'Venmo Launched', year: '2009', description: 'Venmo was launched as a peer‑to‑peer payment app that made splitting bills and sending money to friends as easy as sending a text message. Later acquired by PayPal, it became one of the most popular payment apps among millennials.', link: 'https://en.wikipedia.org/wiki/Venmo#History', source: 'Wikipedia' },
        { title: 'Robinhood Founded', year: '2013', description: 'Robinhood Markets was founded to democratize finance for all by offering commission‑free stock trading. The platform disrupted the brokerage industry and made investing accessible to a new generation of retail investors.', link: 'https://en.wikipedia.org/wiki/Robinhood_(company)#History', source: 'Wikipedia' },
        { title: 'Coinbase Founded', year: '2012', description: 'Brian Armstrong and Fred Ehrsam founded Coinbase, which became the largest cryptocurrency exchange in the United States. The platform made buying, selling, and storing cryptocurrencies simple and secure for mainstream users.', link: 'https://en.wikipedia.org/wiki/Coinbase#History', source: 'Wikipedia' },
        { title: 'Revolut Launched', year: '2015', description: 'Revolut was launched in the UK as a digital banking alternative offering multi‑currency accounts, cryptocurrency trading, and budgeting tools. The fintech unicorn expanded rapidly across Europe and beyond.', link: 'https://en.wikipedia.org/wiki/Revolut#History', source: 'Wikipedia' },
        { title: 'Wise (TransferWise) Founded', year: '2011', description: 'Wise was founded to provide transparent international money transfers at the real exchange rate. The company disrupted traditional banks by offering significantly lower fees for cross‑border payments.', link: 'https://en.wikipedia.org/wiki/Wise_(company)#History', source: 'Wikipedia' },
        { title: 'Plaid Founded', year: '2013', description: "Plaid was founded to connect fintech applications to users' bank accounts securely. The company's API infrastructure powers thousands of financial apps, enabling seamless data sharing between banks and third‑party services.", link: 'https://en.wikipedia.org/wiki/Plaid_(company)', source: 'Wikipedia' },
    ],
    '12-12': [
        { title: 'Apple IPO', year: '1980', description: 'Apple Computer went public at $22 per share, creating instant millionaires among employees and early investors. The IPO was one of the most successful in history at the time.', link: 'https://en.wikipedia.org/wiki/Apple_Inc.#1976%E2%80%931984:_Founding_and_incorporation', source: 'Wikipedia' },
